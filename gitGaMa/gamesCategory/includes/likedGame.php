...
if (isset($_POST['iLikeIt-submit'])){
    ...
    $sql = "INSERT INTO userslikedgames(idUser,idLikedGame) VALUES (?,?);"; //>=place holders
    $prepareStatement = mysqli_prepare($conn,$sql);
        mysqli_stmt_bind_param($prepareStatement,"ii", $ID, $IDgame); //s de la string i integer
    ...
    header("Location: /gitGaMa/gamesCategory/gameTourney.php?username=".$username."&game=".$gameName."&TGnature=".$TGnature."&like=succes");
    exit();
}
?>
